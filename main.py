...
def help():
	...
	print("\n"+"------------------------------------------------------------")
	print("USAGE: python MAIN.py [GENBANK] [SUBJECT] [IDENTITY] [COVERAGE]")
	print("\n"+"------------------------------------------------------------")
	print("USAGE GUIDE FOR EACH PLOT")
	print("[GENBANK]: folder containing every GenBank files that will be compared.")
	print("[SUBJECT]: folder containing multifasta with every query sequence desired to analyse")
	print("-----------------------------------------------------------------")
